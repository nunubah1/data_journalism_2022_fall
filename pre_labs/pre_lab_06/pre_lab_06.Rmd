...
**Answer** Jurisidiction Wide is a created row with NA voters/cast/turnout columns. x1 column is not properly named. There's a Bend row created because SUNRISE BEACH 2 & 3 AND WILSON	 was too long to include Bend into the address name. 
...
**Answer** Although Bend was added to SUNRISE BEACH 2 & 3 AND WILSON adddress, Bend still remains a row as well as Jurisdiction Wide. 
...
**Answer** 21 rows comapared to 23.
