...
**Answer** The last page has a percentage total of both candidates and write-ins. Each of the columns is marked as a character and has commas in them. 
...
**Answer** 2, 3, 4 are referring to the column numbers as they were ordered before the scrap occurred. When I want to get the row sums, I usually add the  columns by using the rowSums function and the column numbers.
...
**Answer** 57. It says it at the top next to the nodeset
...
**Answer** The ones in the quotation marks and have \n in them are links on the site that people can clink on to visit different pages. It makes easy to sort and extract the actual committees later on, so it actually proves useful. 
...
**Answer** It made a chart of all the 57 text elements listed on the site. The ones that are links as well as the ones that are actual committee names.
