...
**Answer** I see that a Geometry type, dimension, bounding box, projected CRS has been added. It's not there for a normal glimpse. As well the shape sections. 
...
**Answer** Polling locations in PG. As well as the precinct and mapping information for those locations. 
...
**Answer** It maps out the precincts in Prince George's County
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Installs and loads the Tigris package.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** loads and glimpses counties throughout the U.S.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code filters the data to only show Maryland counties 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maps out all the counties in Maryland 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It's similar to the previous pg county map but the difference lies at the boundaries. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Shows voting turnout data in PG county ordered by the precincts. Shows total, early, absentee, provisional and eligible.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Joins the precincnt turnout data with the polling locations data
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maps out the total eligible data from the pg precinct with turnout dataset. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Shows the Maryland voting total by counties of all the parties and shows unafiliated and total votes as well. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Shows county population data in Maryland 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Adds mapping information to the population data. Information such as Geometry type, dimensions, bounding box, geodetic crs. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** population and voter number data by counties 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Renamed the NAME column to name. Uppercased the first letter of every county. Remove unnecessary blank spaces. Renames the estimate column to just population.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Joins the population data with the voter by county datasets.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Fixes the the St. Mary's and Baltimore counties that had NA datas. Does so by changing spelling out Sainty and adding County to Baltimore
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Calculates the number of voters per 10,000 population in each county  by joining voters_by_county dataset and creating a new column called voters_by_10k that divides the total by population and multiplies it by 1000
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Maps the previous datase. Arranges the dataset by color. Higher numbers have lighter blue color while the lower numbers have a darker color on the Maryland counties map.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Changes the color of the previous map to various color tones to make the map more visually appealing and easier to understand with having to strain as much.
...
**Answer** Helps see minute differences between other counties by changing the color scale to a log scale
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Calculates the number of unafilliated voters per 10k
...
**Answer** Does what the previous data map does but for unaffiliated voters.
