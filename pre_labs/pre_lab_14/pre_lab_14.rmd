...
**Answer** Produces a list of cardin press release titles and text along with the dates it was published as well as the url. The data contains some blank text spaces. Almost all the texts begins with a "-" which is because the datelines have been removed the intro graf.
...
**Answer** adds dog, and cat and the variations in capitalization to the unique list of words list that R has created. 
...
**Answer** The function ranks the most used words in the text of the press releases.
...
**Answer** It's not really interesting because most of the words that are used are commonly used words like "the," "and" and "to."
...
**Answer** Yes it removes the commonly words that I mentioned back in task 7 and now we can see words like health, support and act that actually means something. 
...
**Answer** In 2021 while covid was still having a big effect on society, health, act, funding, support and covid were the most used words. While in 2022, while the concern of the pandemic has loosened project, health, support, program and funding as the most used words. 
...
**Task** Run the following code and describe the results.
**Answer** Covid 19, human rights, pandemic, and health care are right at the top. Covid 19 is at  .855%, a huge gap from second. 
...
**Task** Run the following code and describe the results.
**Answer** Project location, covid 19, and health care compromise the top 3. Covid 19 declined to .285$ in 2022. 
...
**Answer** Trump being seen as positive. It seemed weird especially considering the way he handled the pandemic. Maybe the meaning of trump might be the reason why the word is seen as positive. 
