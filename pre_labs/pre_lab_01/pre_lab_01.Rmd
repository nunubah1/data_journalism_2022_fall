...
**Answer** It's running the total number of people who contributed each day on the dates of 04/01 through 04/10
...
**Answer** It has picked the dates that have the most number of people who have contributed 
...
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer** Instead of the dates, it's showing which dollar amounts received the most number of contributions from people. For example 25 dollars were contributed by 1419 people
...
```
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer** It shows the total amount of money contributed by a grouped number of contrubutors.
...
**Answer** This one adds the mean amount and the median amount to the table. There are no top results from Maryland.
...
**Answer** It has added the least amount contributed as well as the most amount contributed.It is sorted by the total amount from most to least. It rank orders the cities that have given the most amount of contributions.
