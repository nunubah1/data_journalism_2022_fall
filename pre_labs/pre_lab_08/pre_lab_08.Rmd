...
**Answer** 24. The 25th is has N/A for all the columns. 
...
**Answer** The first line is creating a new dataset from md_voters and saving it. The second line. is arranging the Total Difference column from most to least. The second line is choosing which columns to desplay. Head (10) is just showing the top 10. Nothing more and nothing less.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar chart of task 3. But the chart is unorganized and not appealing visually. 
...
**Answer** This organize the bar graph in order from least to most. It also changed the county x header to reorder(County,TOTAL_DIFF)
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** It flipped the x and y axis around and organized it from most to least.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** It removed the gray background and made it white. 
...
**Answer** Gave it the economist theme. Which is a light blue ish background. The font looks a bit bigger and a bit bolder. 
```{r}
maryland_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(County,TOTAL_DIFF), weight=TOTAL_DIFF)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** There is title now called "Maryland Counties with Biggest Increases in Voters". And the x and y axis are renamed  to county and net change respectively.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** An organized by day list of total contributions from April 1, 2022 to June 30, 2022.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A line graph of task 12. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** It's the same line graph but now it's breaking it down the scale by week 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** It changed the angle of the dates appearing on the bottom. 
```{r}
md_winred_by_date %>%
  ggplot() + 
  geom_line(aes(x=date, y=total_contributions)) + 
