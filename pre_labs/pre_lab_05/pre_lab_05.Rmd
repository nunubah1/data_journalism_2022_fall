...
cleaned_dc_food <- read.csv("data/cleaned_dc_food.csv")
...
**Answer** The spelling's of the receipient names do not match. Like you have Walters, Walters Sport and Walters Sports, Walters Sports Bar all potentially signifying the same thing. They all separate individual counts. 
...
**Answer** It changed "LE DIPLOMATE, LE DIPLOMATE" to just "LE DIPLOMATE". I only noticed one change within the first 20 results. 
...
**Answer** "W. MILLAR & CO" changed to "W. MILLAR & CO." "WALTER'S SPORTS BAR" change to "WALTERS SPORTS BAR" and "HILTON WASHINGTON" changed to "WASHINGTON HILTON"		
...
**Answer** The changes made don't seem substantial.
