...
**Answer** Yes, all 3 data files have the same column structures
...
**Answer** 24. But should be 25 b/c of the total row column that's non existent in the maryland population but is existent in the conty voters datas.
...
```
```{r}
maryland_population %>% right_join(county_voters_2020, by="COUNTY")
```
...
**Answer** I didn't get an error message when running the code below. I'm not sure why I ddin't though. 
...
**Answer** Prince George's County, 60.9% 18+. About 78.3% democrat. 
...
**Answer** Howard County, about 19.4% 18+. T About 52.4% democrat. There's about a 41.5% difference in population as a percentage of all population 18 and over. PG County has 41.5% more 18+ blacks in their county than Howard county has 18+ asains in their county. PG has 25.9% more democrats residing in their county than Howard County. 
...
**Answer** number (dbl) variable. Zip codes of Maryland cities
...
**Answer** It's now a character (chr) variable. Zip codes of Maryland cities.
