...
https://datawrapper.dwcdn.net/A8U6J/1/
...
md_gov_county <- md_gov_county %>% 
  mutate(total = rowSums(md_gov_county[,3:8])) %>% 
...
**Answer** The map goes from showing the entire United States uncolored to showing Maryland with colored county regions and percentage of Wes Moore votes in each of the counties and Baltimore City. 
...
**Answer** Changes the percent format shown of Wes Moore vote to the tenths place from showing over the millionths place. 
...
**Answer** https://datawrapper.dwcdn.net/rqQtN/1/
