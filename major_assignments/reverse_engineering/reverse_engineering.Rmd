...
* **Analysis summary**: Our data said that Moore had more than $4 million out-of-state contributions. 9,449 contributions for $4,098,495 to be exact.

Perez on the other hand, had more than $2.4 million out-of-state contributions. 3,601 contributions for $2,451,371 to be exact. 

We didn't clean our data properly. I think this has to do with the date range. Stephen's article was posted in March but the data goes as far as August. 
