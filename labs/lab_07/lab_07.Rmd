...
five_to_seventeen_pop <- get_acs(geography = "county",
              variables = c(five_to_seventeen_pop = "B09001_001"),
              state = "MD",
              year = 2020,)
````
```{r}
youth_spanish_anglais_vw <- get_acs(geography = "county",
              variables = c(five_to_seventeen_pop = "B16004_005"),
              state = "MD",
              year = 2020)
...
pa_zips_with_acs <- pa_zip_totals %>% left_join(pa_zipcodes, by=c('zip5'='GEOID'))
